...
class irodsInfo(PyQt6.QtWidgets.QWidget, gui.ui_files.tabInfo.Ui_tabInfo):
    ...
    def refresh_info(self):
        ...
        # irods Zone
        self.zoneLabel.setText(self.ic.get_zone)
        # irods user
        self.userLabel.setText(self.ic.get_username)
        ...
        self.serverLabel.setText(self.ic.get_host)
        self.versionLabel.setText(
            '.'.join((str(num) for num in self.ic.get_server_version)))
        # irods resources
