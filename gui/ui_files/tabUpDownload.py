# Form implementation generated from reading ui file 'gui/ui_files/tabUpDownload.ui'
#
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_19.setText(_translate("Form", "LOCAL"))
        self.createFolderButton.setText(_translate("Form", "Create Folder"))
        self.label_2.setText(_translate("Form", "Select: resource / free GB"))
        self.resourceBox.setItemText(0, _translate("Form", "Resources"))
        self.label_20.setText(_translate("Form", "IRODS"))
        self.irodsZoneLabel.setText(_translate("Form", "Zone"))
        self.createCollButton.setText(_translate("Form", "Create Collection"))
