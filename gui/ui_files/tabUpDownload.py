# Form implementation generated from reading ui file 'D:\Christine_irods\iBridges-Gui\gui\ui_files\tabUpDownload.ui'
#
...
"}")
        ...
        if getattr(sys, 'frozen', False):
                icon.addPixmap(QtGui.QPixmap(join(dirname(realpath(sys.argv[0])), pardir) + "/icons/arrow-right.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        else:
                icon.addPixmap(QtGui.QPixmap(dirname(realpath(sys.argv[0])) + "/icons/arrow-right.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        if getattr(sys, 'frozen', False):
                icon1.addPixmap(QtGui.QPixmap(join(dirname(realpath(sys.argv[0])), pardir) + "/icons/arrow-left.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        else:
                icon1.addPixmap(QtGui.QPixmap(dirname(realpath(sys.argv[0])) + "/icons/arrow-left.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
