...
"}")
        ...
        if getattr(sys, "frozen", False):
            icon.addPixmap(QtGui.QPixmap("../gui/ui_files/../icons/refresh.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        else:
            icon.addPixmap(QtGui.QPixmap("gui/ui_files/../icons/refresh.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        if getattr(sys, "frozen", False):
            icon1.addPixmap(QtGui.QPixmap("../gui/ui_files/../icons/arrow-up.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        else:
            icon1.addPixmap(QtGui.QPixmap("gui/ui_files/../icons/arrow-up.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        if getattr(sys, "frozen", False):
            icon2.addPixmap(QtGui.QPixmap("../gui/ui_files/../icons/home.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        else:
            icon2.addPixmap(QtGui.QPixmap("gui/ui_files/../icons/home.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def retranslateUi(self, tabBrowser):
        ...
        item.setText(_translate("tabBrowser", "Resource hierarchy"))
