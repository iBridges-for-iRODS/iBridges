...
data structures to be able to use all the features of the underlying `python-irodsclient <https://github.com/irods/python-irodsclient>`__
library. Alternatively, users can use the :doc:`Command Line Interface <cli>` or the `Graphical User Interface <https://github.com/chStaiger/iBridges-Gui>`__.
